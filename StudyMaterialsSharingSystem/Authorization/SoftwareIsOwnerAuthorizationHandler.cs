...
{
    public class SoftwareIsOwnerAuthorizationHandler
        : AuthorizationHandler<OperationAuthorizationRequirement, Book>
    {
        UserManager<ApplicationUser> _userManager;
        public SoftwareIsOwnerAuthorizationHandler(UserManager<ApplicationUser>
        userManager)
        {
        ...
        protected override Task HandleRequirementAsync(
            ...
            OperationAuthorizationRequirement requirement, Book resource)
        {
